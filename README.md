...
#### i. Machine Learning Methods and Tools <sup>1</sup>
...
#### ii. Data Analytics for Machine Learning <sup>1</sup>
...
#### iii. Supervised Learning Methods <sup>1</sup>
...
#### iv. Natural Language Processing <sup>1</sup>
...
#### v. Unsupervised Learning Methods <sup>1</sup>
...
> To create applications using: OpenAI and IBM Watson. With hands-on learning, discover how to integrate technology like Text-to-Speech, Speech-to-Text, and Natural Language Process (NLP) into your own applications. 

1. Create a Voice Assistant with OpenAI's GPT-3 and IBM Watson 
2. Build a Brand Sentiment Analysis Extension for Twitter 
3. Improve Customer Support with AI-Powered Services  
4. How do people feel about a product? Use AI to get the answer
